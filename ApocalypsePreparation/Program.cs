        ...
        static void Main(string[] args)
        {
            ...
            while (!areOver)
            {
                ...
                if (currentHealingItemName != "")
                {
                    ...
                    {
                        int elementForChange = medicaments.Pop();
                        medicaments.Push(elementForChange + remainingMedicament);
